...
*/
let meWithNoAge = delete me.age;
  

/* ESERCIZIO E
  Crea del codice per aggiungere programmaticamente all'oggetto precedentemente creato un array chiamato "skills", contenente i linguaggi di programmazione che conosci.
*/
 me.skills = ["c#","js","css","html"]
/* ESERCIZIO F
...
console.log(splitMe("giande per tutti tranne che per te"))
/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare senza l'ultimo.
*/
const deleteOne = (text,removeFirst)=> {
  if(removeFirst){
...
console.log(deleteOne("pinguino",true))
/* ESERCIZIO 5
...
console.log(onlyLetters("1 2 3 stella"))
/* ESERCIZIO 6
...
console.log(isThisAnEmail("ginoparmigino.vattelapesca@gmail.com"))
/* ESERCIZIO 7
...
const pastDate = new Date("1997-03-06");
console.log(howManyDays(pastDate)); 
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
const isTodayMyBirthday = () => {
  const myBirthdayDay = 6
  const myBirthdayMonth = 3

  const today = new Date()
  const todayDay = today.getDate()
  const todayMonth = today.getMonth() + 1
  return todayDay === myBirthdayDay && todayMonth === myBirthdayMonth;
};
...
const deleteProp = (oggetto,stringa)=> {
 if(oggetto && stringa){
  ...
  console.log("devi passarmi sia l'oggetto su cui vioi lavorare sia il paramentro che vuoi eliminare")
 }
}
console.log(deleteProp(x,"eta"))
/* ESERCIZIO 12
...
const onlyTheYears = ()=>{
  let arryaOfYears = []
 for(let i = 0; i< movies.length; i++){
  arryaOfYears.push(movies[i].Year)
 }
 return arryaOfYears
}
...
const onlyInLastMillennium = ()=>{
  let arryaOfOldMovies = []
 for(let i = 0; i< movies.length; i++){
  if(movies[i].Year<2000){
    arryaOfOldMovies.push(movies[i].Year)
  }
 }
 return arryaOfOldMovies
}
...
searchAndDivide("The Lord of the Rings")
/* ESERCIZIO 19
